                ...
                <div className="lg:col-span-2">
                    ...
                    <div className="space-y-4">
                        {urgentAssignments.length > 0 ? urgentAssignments.map(assignment => {
                            // Fix: Parse due_at string to Date
                            ...
                            return (
                                <div key={assignment.id} className="bg-gray-800 rounded-lg p-4 flex items-center justify-between transition-transform hover:scale-105 duration-200">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-400">Due {getRelativeDate(dueDate)}</p>
                                    </div>
                                    <div className={`text-sm font-bold px-3 py-1 rounded-full ${isToday(dueDate) ? 'bg-red-500/20 text-red-400' : 'bg-yellow-500/20 text-yellow-400'}`}>
