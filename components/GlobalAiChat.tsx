...
// Fix: Import missing AiTutorMessage type
import { AiTutorMessage, Course, Assignment } from '../types';
// Fix: Import missing createGlobalAssistantChat function
